...
public class AdapterHeader extends BaseAdapter {
    ...
    public AdapterHeader(Context context, ArrayList<Ingredient> arr) {
        if (arr != null) {
            data = arr;
        }
    ...
    public View getView(int i, View someView, ViewGroup arg2) {
        ...
        if (someView == null) {
            someView = inflater.inflate(R.layout.ingredient_item, arg2, false);
        }
        //Обявляем наши текствьюшки и связываем их с разметкой
        TextView name = (TextView) someView.findViewById(R.id.nameI);
        // TextView cover = (TextView) someView.findViewById(R.id.textView2);

        TextView count = (TextView) someView.findViewById(R.id.countI);
