 ...
 */
class AdapterElement extends BaseAdapter {

    ArrayList<ElementTvShow> data = new ArrayList<ElementTvShow>();
    Context context;

    public AdapterElement(Context context, ArrayList<ElementTvShow> arr) {
        if (arr != null) {
            data = arr;
        }
    ...
    public View getView(int i, View someView, ViewGroup arg2) {
        ...
        if (someView == null) {
            someView = inflater.inflate(R.layout.elemet_list, arg2, false);
        }
        //Обявляем наши текствьюшки и связываем их с разметкой
        TextView name = (TextView) someView.findViewById(R.id.name_tv_show);
        TextView sezon = (TextView) someView.findViewById(R.id.sezon_tv_show);
        TextView episodNum = (TextView) someView.findViewById(R.id.episod_tv_show);
        TextView episodName = (TextView) someView.findViewById(R.id.name_episod_tv_show);
        TextView dataTv = (TextView) someView.findViewById(R.id.tv_data);
        ImageView coverTv = (ImageView) someView.findViewById(R.id.cover_tv_show);
